      ...
      <div id="myCarousel" class="carousel slide hidden-xs" data-ride="carousel">
        ...
        <ol class="carousel-indicators">
          ...
          <div class="item active">
            <img src="assets/img/valor-banner.png" style="width:100%" data-src="holder.js/900x500/auto/#7cbf00:#fff/text: " alt="First slide">
            <!-- <div class="container">
          ...
          <div class="item">
            <img src="assets/img/dota2-banner.png" style="width:100%" data-src="" alt="Second    slide">
          </div>
          <div class="item">
            <img src="assets/img/apex-banner.png" style="width:100%" data-src="" alt="Third slide">
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 ">
          <div class="case-study study1">
            <div class="case-study__overlay col-md-3 col-sm-4 col-xs-6 col-md-offset-1">
              <h2 class="case-study__title">Game Menu</h2>
              <a class="case-study__link" href="#">View Details</a>
            </div>
          </div>
          <div class="case-study study2">
            <div class="case-study__overlay col-md-3 col-sm-4 col-xs-6">
